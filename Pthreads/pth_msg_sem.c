...
void *Send_msg(void* rank) {
   ...
   sem_post(&semaphores[dest]);  /* Desbloquea el semáforo de dest */

   /// bloquea semaforo o disminiuye valor
   sem_wait(&semaphores[my_rank]);  /* Espera a que se desbloquee nuestro semáforo*/
